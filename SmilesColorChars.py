...
path = "SavedModels/SmilesColorChars/"
modelName = "T3_F16_SmilesColorCharsModel"
batch_size = 32
nb_epoch = 100
verbose = 1
...
DirTrainImg = "HIVImages/SmilesColorCharsImages/Train/"
DirTestImg = "HIVImages/SmilesColorCharsImages/Test/"
DirTensorArray = "HivData/SmilesColorCharsArray/"

# Loading trainig HivData
if os.path.exists("HivData/SmilesColorCharsArray/X_Train.pickle"):
    print("Local train HivData was found" + "\n")
    pickle_in = open("HivData/SmilesColorCharsArray/X_train.pickle", "rb")
    X_train_and_valid = pickle.load(pickle_in)

    pickle_in = open("HivData/SmilesColorCharsArray/y_Train.pickle", "rb")
...
if os.path.exists("HivData/SmilesColorCharsArray/X_Test.pickle"):
    print("Local test HivData was found" + "\n")
    pickle_in = open("HivData/SmilesColorCharsArray/X_Test.pickle", "rb")
    X_test = pickle.load(pickle_in)

    pickle_in = open("HivData/SmilesColorCharsArray/y_Test.pickle", "rb")

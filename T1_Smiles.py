...
DirTrainArray = "Data/SmilesArray/"
DirTestArray = "Data/SmilesArray/"

# Loading trainig data
if (os.path.exists("Data/SmilesArray/trainData.pickle")):
    print("Local train data was found" + "\n")
    pickle_in = open("Data/SmilesArray/trainData.pickle","rb")
...
if (os.path.exists("Data/SmilesArray/testData.pickle")):
    print("Local test data was found" + "\n")
    pickle_in = open("Data/SmilesArray/testData.pickle","rb")

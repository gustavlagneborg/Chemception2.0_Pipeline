...
if os.path.exists("Data/SmilesColorArray/X_Train.pickle"):
    ...
    pickle_in = open("Data/SmilesColorArray/X_train.pickle", "rb")
    X_train_and_valid = pickle.load(pickle_in)

    pickle_in = open("Data/SmilesColorArray/y_Train.pickle", "rb")
...
if os.path.exists("Data/SmilesColorArray/X_Test.pickle"):
    ...
    pickle_in = open("Data/SmilesColorArray/X_Test.pickle", "rb")
    X_test = pickle.load(pickle_in)

    pickle_in = open("Data/SmilesColorArray/y_Test.pickle", "rb")

...
DirTrainImg = "HIVImages/SmilesImages/Train/"
DirTestImg = "HIVImages/SmilesImages/Test/"
DirTensorArray = "HivData/SmilesArray/"

# Loading trainig HivData
if os.path.exists("HivData/SmilesArray/X_Train.pickle"):
    print("Local train HivData was found" + "\n")
    pickle_in = open("HivData/SmilesArray/X_train.pickle", "rb")
    X_train_and_valid = pickle.load(pickle_in)

    pickle_in = open("HivData/SmilesArray/y_Train.pickle", "rb")
...
if os.path.exists("HivData/SmilesArray/X_Test.pickle"):
    print("Local test HivData was found" + "\n")
    pickle_in = open("HivData/SmilesArray/X_Test.pickle", "rb")
    X_test = pickle.load(pickle_in)

    pickle_in = open("HivData/SmilesArray/y_Test.pickle", "rb")
